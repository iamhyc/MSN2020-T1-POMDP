...
%FIXME: fix the following comments for short
% \comments{
...
In our proposed approximate solution framework, we extend this procedure to the POMDP problem in P1 by exploiting the structure of \comments{partially observed edge computing networks}.
...
\end{lemma}
\begin{proof}
    %FIXME: fix with small inspiration
    \comments{The complete proof is provided in another version, and here the short inspiration is given.}
\end{proof}
