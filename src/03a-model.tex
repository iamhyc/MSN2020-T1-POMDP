...
% It's assumed that the edge servers are collocated with APs and there are at most one edge server on one AP.
...
The job dispatchers are implemented on the APs in a distributed manner.
