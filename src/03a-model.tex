...
We consider cloud server as one of the processing server with stronger computation capability, but also with larger transmission latency and signaling latency compared with other edge servers.
