...
\comments{
    However, due to the constrain of broadcast information sharing on network topology, each AP only has its own OSI, however the optimal dispatching actions depends on the GSI and global \brlatency~information according to the RHS of equation (\ref{eqn:sp_0}).
